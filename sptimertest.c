/*Check speed and time spent in each thread*/
...
int main(void) {
    ...
    total_t1 = (float)(count1/CLOCK_SPEED);
    total_t2 = (float)(count2/CLOCK_SPEED);

    printf("count1 = %d, count2 = %d\n", count1, count2); 
    printf("Thread 1 returns: %d\n", iret1); 
    printf("Thread 2 returns: %d\n", iret2); 
    printf("Total time taken by CPU for thread1 20000 ticks: %f ms\n", total_t1);
    printf("Total time taken by CPU for thread2 20000 ticks: %f ms\n", total_t1);
    exit(0); 
    //return EXIT_SUCCESS; 
} 
